...
wget -nc https://us-west-2-tcdev.s3.amazonaws.com/courses/AWS-100-ADO/v1.0.0/exercises/ex-elasticache.zip -O ~/ex-elasticache.zip
cd ~/environment
...
echo $MEMCACHED_HOST 
python3 ex-elasticache/FlaskApp/application.py